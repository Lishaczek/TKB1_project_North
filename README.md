# North 🦊❄️
Atmosférické interaktivní dobrodružství polární lišky v nehostinné arktické krajině.
Vytvořeno pod hlavičkou **FrostBound Studio**.
...
Pro spuštění hry je vyžadován **Python 3.x** a knihovna **Pillow** pro zpracování obrázků.
